...
export function SettingsPanel() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 min-h-full transition-colors animate-fadeIn">
      <div className="glass-panel rounded-[2rem] shadow-2xl border-white/10 overflow-hidden">
        ...
        <div className="border-b border-white/5 px-8 py-8 bg-white/5 dark:bg-black/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-5">
              <div className="w-14 h-14 rounded-2xl glass-panel flex items-center justify-center text-blue-500 shadow-xl shadow-blue-500/10 active:scale-95 transition-transform cursor-pointer">
        ...
        <div className="p-8 space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={mod.key}
                  className="p-6 glass-panel bg-white/5 dark:bg-black/10 border-white/5 rounded-[1.5rem] flex items-center justify-between group hover:border-blue-500/30 hover:bg-white/10 transition-all duration-300 shadow-sm"
                >
                  <div className="flex items-center gap-5">
                    <div className="w-12 h-12 rounded-2xl glass-panel flex items-center justify-center text-xl shadow-inner bg-black/5">
                      {mod.icon}
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-500 ${settings[mod.key as keyof SystemSettings] ? 'bg-blue-600 shadow-lg shadow-blue-500/30' : 'bg-gray-300 dark:bg-white/10'}`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-all duration-500 shadow-xl ${settings[mod.key as keyof SystemSettings] ? 'translate-x-6' : 'translate-x-1'}`}
                    />
                  </button>
                </div>
              ))}
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 glass-panel bg-gradient-to-br from-emerald-500/5 via-transparent to-teal-500/5 border-emerald-500/10 rounded-[1.5rem] flex items-center justify-between transition-all shadow-[0_10px_40px_rgba(16,185,129,0.05)]">
              ...
              <button
                ...
                className={`relative inline-flex h-7 w-12 items-center rounded-full transition-all duration-500 ${settings.auto_learning_enabled ? 'bg-emerald-600 shadow-xl shadow-emerald-500/30' : 'bg-gray-300 dark:bg-white/10'}`}
              >
                <span
                  className={`inline-block h-5 w-5 transform rounded-full bg-white transition-all duration-500 shadow-md ${settings.auto_learning_enabled ? 'translate-x-6' : 'translate-x-1'}`}
                />
              </button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-8 glass-panel bg-white/5 dark:bg-black/10 border-white/5 rounded-[1.5rem] flex items-center justify-between group transition-all hover:bg-white/10 shadow-sm">
              ...
              <button
                ...
                disabled={!settings.auto_learning_enabled}
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-500 ${settings.test_before_learning ? 'bg-blue-600 shadow-lg shadow-blue-500/30' : 'bg-gray-300 dark:bg-white/10'}`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-all duration-500 shadow-md ${settings.test_before_learning ? 'translate-x-6' : 'translate-x-1'}`}
                />
              </button>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-8 glass-panel bg-white/5 dark:bg-black/10 border-white/5 rounded-[1.5rem] flex items-center justify-between group transition-all hover:bg-white/10 shadow-sm">
                ...
                <button
                  ...
                  className={`relative inline-flex h-5 w-10 items-center rounded-full transition-all duration-500 ${settings.enable_audit_log ? 'bg-blue-600 shadow-lg shadow-blue-500/20' : 'bg-gray-300 dark:bg-white/10'}`}
                >
                  <span
                    className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-all duration-500 shadow-sm ${settings.enable_audit_log ? 'translate-x-[1.375rem]' : 'translate-x-1'}`}
                  />
                </button>
              </div>
          ...
          {/* Info Section */}
          <div className="p-8 glass-panel bg-blue-500/5 border-blue-500/10 rounded-[1.5rem] transition-all">
            <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-blue-600 dark:text-blue-400 mb-6 flex items-center gap-3">
              <div className="p-1 glass-panel bg-blue-500/10 rounded-lg">
                <Info className="w-4 h-4" />
              </div>
              Evolution Protocol & Intelligence
            </h4>
