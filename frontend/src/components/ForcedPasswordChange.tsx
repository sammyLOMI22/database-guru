...
export default function ForcedPasswordChange({ username, onChanged, onLogout }: ForcedPasswordChangeProps) {
      ...
      <div className="w-full max-w-md mx-4 animate-fadeIn">
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-xl border border-white/20 dark:border-white/5">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-5">
            An administrator reset your password. Set a new one to continue, {username}.
          </p>
