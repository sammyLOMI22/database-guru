...
export default function Sidebar({ onClose, onSelectQuery, onConnectionSelect }: SidebarProps) {
  ...
  return (
    <aside className="w-[400px] glass-panel border-r border-white/10 flex flex-col transition-all duration-500 relative z-20 overflow-hidden shadow-[20px_0_50px_rgba(0,0,0,0.3)]">
      {/* Header */}
