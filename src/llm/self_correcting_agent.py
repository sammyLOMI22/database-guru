            ...
            try:
                ...
                if attempt_num == 1:
                    ...
                    if sql is None:  # Only generate if not already generated by planner
                        # OPTIMIZATION: Don't use tool-using agent during initial generation
                        # Tool-using agent is more valuable during error correction where we know what went wrong
                        # For initial generation, Query Planning provides better structured approach
