"""Prompts for SQL generation, intent classification, and few-shot examples."""

from src.llm.prompts.dialects import get_dialect_rules
...
# Intent-specific SQL requirements (Phase 1 - SQL Quality Enhancement)
